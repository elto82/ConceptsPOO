...
namespace ConceptsPOO
{
    public class Date
    {
        ...
        {
            // validar cuando un 29 de febrero es valido o no. un año dura 365,25... cada 100 años no es biciesto cada 400 si
        ...
        { 
            ...
            //codigo redunte para validar si un año es biciesto
            //if (year % 4 == 0)
            //{
            //    if (year % 100 == 0)
            //    {
